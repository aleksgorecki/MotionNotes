...
import com.example.motionnotes.ml.BasicModel;
...
public class MotionDetector implements SensorEventListener {
    ...
    public static class MotionDetectedEvent {
        ...
        public final MotionClass detectedMotion;

        public MotionDetectedEvent(MotionClass detectedMotion) {
    ...
    public static class MotionDetectorStateEvent {
        ...
        public final DetectorState newState;

        public MotionDetectorStateEvent(DetectorState newState) {
